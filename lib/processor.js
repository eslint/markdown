...
// Adding PG specific 'example' syntax for linting Styleguidist
var SUPPORTED_SYNTAXES = ["js", "javascript", "node", "jsx", "example"];
var UNSATISFIABLE_RULES = [
    "eol-last", // The Markdown parser strips trailing newlines in code fences
    // PG specific unsatisfiable rules based on Styleguidist markdown rules
    "react/jsx-no-undef",
    "semi",
