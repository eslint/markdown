...
## [9.0.0](https://github.com/eslint/markdown/compare/v8.0.3...v9.0.0) (2026-09-25)
...
* mask footnote references in `no-reversed-media-syntax` ([#743](https://github.com/eslint/markdown/issues/743)) ([03bcec5](https://github.com/eslint/markdown/commit/03bcec5a1cec4648120126c061e51b7078fc45f5))
...
* allow `InlineConfigComment` node to be reported ([#652](https://github.com/eslint/markdown/issues/652)) ([65aaadf](https://github.com/eslint/markdown/commit/65aaadf1e87c6c07b43d591062cbf825be8ca018))
...
* Require Node.js ^20.19.0 || ^22.13.0 || >=24 ([#561](https://github.com/eslint/markdown/issues/561))
...
* add option to no-duplicate/unused-definitions rules ([#616](https://github.com/eslint/markdown/issues/616)) ([d189c5e](https://github.com/eslint/markdown/commit/d189c5e2c5ff8d03c3d7e16905a227d5c5e584ac))
* fix incorrect regex pattern in `no-multiple-h1` ([#624](https://github.com/eslint/markdown/issues/624)) ([e57e398](https://github.com/eslint/markdown/commit/e57e39835f50ec1198f7fadb5e5cd600383fbc6c))
...
* Require Node.js ^20.19.0 || ^22.13.0 || &gt;=24 ([#561](https://github.com/eslint/markdown/issues/561)) ([f6d2a22](https://github.com/eslint/markdown/commit/f6d2a22ae210bcdee9c6487c13bab11c5403eed2))
* support Math ([#617](https://github.com/eslint/markdown/issues/617)) ([cc03b5f](https://github.com/eslint/markdown/commit/cc03b5fae54337f5de012a41c5af438b281818a1))
...
* recognize HTML heading in `no-missing-link-fragments` ([#583](https://github.com/eslint/markdown/issues/583)) ([bd9dfa3](https://github.com/eslint/markdown/commit/bd9dfa38fb5af611c018f5ae8d163ff28e936c56))
...
* update dependency @eslint/plugin-kit to ^0.6.0 ([#584](https://github.com/eslint/markdown/issues/584)) ([be16763](https://github.com/eslint/markdown/commit/be16763a550574febaba2dfa4f7c3ad197c3b83c))
* update eslint ([#629](https://github.com/eslint/markdown/issues/629)) ([4c75af0](https://github.com/eslint/markdown/commit/4c75af059f27afd4f94ab5e42882bfcead5e0ba4))
* use types from `@eslint/plugin-kit` and update `@eslint/core` ([#607](https://github.com/eslint/markdown/issues/607)) ([f5d4ce0](https://github.com/eslint/markdown/commit/f5d4ce075e7285019a0be274342dfff769a3aa34))
