...
ruleTester.run("no-reversed-media-syntax", rule, {
	...
	invalid: [
		...
		// Backslash escaping
		{
			code: `${"\\".repeat(2)}(foo)[bar]`,
			output: `${"\\".repeat(2)}[foo](bar)`,
			errors: [
				{
					messageId: "reversedSyntax",
					line: 1,
		...
		{
			code: `${"\\".repeat(4)}(foo)[bar]`,
			output: `${"\\".repeat(4)}[foo](bar)`,
			errors: [
				{
					messageId: "reversedSyntax",
					line: 1,
		...
		{
			code: `${"\\".repeat(6)}(foo)[bar]`,
			output: `${"\\".repeat(6)}[foo](bar)`,
			errors: [
				{
					messageId: "reversedSyntax",
					line: 1,
		...
		{
			code: `${"\\".repeat(8)}(foo)[bar]`,
			output: `${"\\".repeat(8)}[foo](bar)`,
			errors: [
				{
					messageId: "reversedSyntax",
					line: 1,
